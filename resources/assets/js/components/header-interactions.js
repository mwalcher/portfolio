...
export default function({
    ...
    mobileMenu.addEventListener('click', () => toggleNavigation(openNavigationClass));
    ...
    window.addEventListener('load', () => activeSection(sections, navigation, navigationItems));
    window.addEventListener('scroll', throttle(() => activeSection(sections, navigation, navigationItems), 250));
}
