    ...
    <section class="hero section">
        <div class="hero-content">
            ...
            <div class="contact-links">
                <a href="{!! __('global.contact-links.linkedin.link') !!}" target="_blank" class="no-hover" title="{!! __('global.contact-links.linkedin.title') !!}">
                    <span class="icon fa {!! __('global.contact-links.linkedin.icon') !!}" aria-hidden="true"></span>
                    {!! __('global.contact-links.linkedin.text') !!}
                </a>
                <a href="{!! __('global.contact-links.github.link') !!}" target="_blank" class="no-hover" title="{!! __('global.contact-links.github.title') !!}">
