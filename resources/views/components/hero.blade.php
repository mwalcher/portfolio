<section id="{!! __($page.'.hero.id') !!}" class="hero section">
    ...
    <div class="tab-content">
        <div class="tab-container">
            ...
            <button class="tab @if($loop->index == 0)active @endif" data-toggle="{!! $tabContent['title'] !!}" data-toggle-parent="tab-content" title="{!! $tabContent['title'] !!}">{!! $tabContent['title'] !!}</button>
            @endforeach
        </div>

        <div class="tab-content-container">
            @foreach (__($page.'.tab-content') as $tabContent)
            <div class="content-container @if($loop->index == 0)active @endif" data-toggle-content="{!! $tabContent['title'] !!}"  data-toggle-parent="tab-content">
