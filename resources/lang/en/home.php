...
return [
    ...
    'tab-content' => [
        ...
        'about' => [
            'title' => 'About Me',
            'content' => [
                'Welcome! I appreciate your interest, so allow me to introduce myself, I am Matthew Walcher and I am working as the web developer on the Marketing team at <a class="animated-hover" href="'.__('global.roles.tophat.link').'" target="_blank" rel="noopener" title="'.__('global.roles.tophat.title').'">'.__('global.roles.tophat.text').'</a>. Please enjoy this website that I designed to showcase my experience in front-end web development.',
                'At <a class="animated-hover" href="'.__('global.roles.tophat.link').'" target="_blank" rel="noopener" title="'.__('global.roles.tophat.title').'">'.__('global.roles.tophat.text').'</a> and in my previous role at <a class="animated-hover" href="'.__('global.roles.arcane.link').'" target="_blank" rel="noopener" title="'.__('global.roles.arcane.title').'">'.__('global.roles.arcane.text').'</a>, I have a reputation for the highest quality product because of my strong work ethic and attention to detail. From the beginning of a project I think through the desired outcome first before I start to build to ensure I have the optimal solution the first time. I love to collaborate and bounce ideas off my peers when working through tasks because I know I can benefit from other perspectives on how to create the best products for our team and clients.',
