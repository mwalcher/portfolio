...
return [
    ...
    'navigation' => [
        ...
        'showcase' => [
            ...
            'title' => __('projects.navigation.showcase.title').__('global.projects.libro.name'),
    ...
    'hero' => [
        ...
        'button' => [
            ...
            'title' => __('projects.hero.button.title').__('global.projects.libro.name'),
    ...
    'tab-content' => [
        ...
        'work' => [
            ...
            'content' => [
                'The calculators are built in <a class="animated-hover" href="https://reactjs.org/" target="_blank" rel="noopener" title="React website">React</a> using the <a class="animated-hover" href="https://facebook.github.io/create-react-app/" target="_blank" rel="noopener" title="Create React App website">Create React App</a> framework from Facebook. I was the front-end developer on this project and I worked with a designer, an intermediate back-end developer and I had the support of one of the senior back-end developers. The intermediate back-end developer set up API routes for me to access and pass data to. The senior back-end developer helped me build the scaffold for the calculators.',
                ...
                'Each of the calculators is built to store the data from each step in <a class="animated-hover" href="https://redux.js.org/" target="_blank" rel="noopener" title="Redux website">Redux</a> and then provide the user with a summary once they are finished the steps. Part of the value of the calculators is analyzing the data and performing calculations for the user such as their estimated total mortgage and payment amount based on the payment frequency they chose.'
            ]
        ]
    ],
    'main-content' => [
        ...
        'components' => [
            'showcase-slider' => [
                ...
                'cta' => [
                    'text' => __('projects.main-content.showcase-slider-cta').__('global.projects.libro.name'),
                    'title' => __('projects.main-content.showcase-slider-cta').__('global.projects.libro.name'),
