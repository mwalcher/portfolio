...
return [
    ...
    'navigation' => [
        ...
        'showcase' => [
            ...
            'title' => __('projects.navigation.showcase.title').__('global.projects.whats-my.name'),
    ...
    'main-content' => [
        ...
        'components' => [
            'showcase-slider' => [
                ...
                'cta' => [
                    'text' => __('projects.main-content.showcase-slider-cta').__('global.projects.whats-my.name'),
                    'title' => __('projects.main-content.showcase-slider-cta').__('global.projects.whats-my.name'),
